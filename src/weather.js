...
export default class Weather extends React.Component{
    ...
    constructor(props){
        ...
        //bind functions called from HTML
        this.handleChange = this.handleChange.bind(this)
        this.checkWindSpeed = this.checkWindSpeed.bind(this)
		this.checkZipLength = this.checkZipLength.bind(this)
	...
	function ucfirst(str,force){
     ...
     $(function () {
		 console.log("running focusedElement")
		...
		<div id="weather" name="weather" style={{margin:"30px",border:"1px solid black",maxHeight:"250px",overflowX:"hidden", overflowY:"auto"}}>
			 <hr style={{height:"5px",border:"none",color:"#333",backgroundColor:"#333"}} />
                    <div className="row">
